...
- Give troubleshoot advice when something is not working before any other guidance
...
0. If question is about a bug: Guide the troubleshoot ("You can check the following...")
